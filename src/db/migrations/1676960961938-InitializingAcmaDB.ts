...
export class InitializingAcmaDB1676960961938 implements MigrationInterface {
  name = 'InitializingAcmaDB1676960961938';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "user_modules" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid, "module_id" uuid, CONSTRAINT "PK_01ede6942013a660f81c456031e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
